...
<div class="form-group">
    <input type="hidden" name="id" class="form-control" value="{{$sliders->id}}" />
     ...
     <span class=""> <img src="{{@$sliders->image}}" alt="" hieght="150px" width="150px"> </span>
    </div>
    <div class="form-group">
     <label>Title</label>
    ...
    <div class="form-group">
     ...
     <textarea name="description" class="form-control textarea" value="">{{ $sliders->description }}</textarea>
    </div>
    <div class="form-group">
