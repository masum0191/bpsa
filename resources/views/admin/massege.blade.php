...
@section('contant')
<p class=" text-center text-info h4 "><i>Massege Lists</i></p>
<a class="btn btn-primary btn-sm" href="{{url('admin/massege/create')}}"> 
     New massege</a> 
...
<tr>
   ...
   <td>{!!@$order->id !!}</td>
    ...
    <td> 
    @if(@$order->status==1)
    <a class="btn btn-primary btn-sm" href="{{url('admin/massege/innotice/'.@$order->id)}}"><i class="fa fa-solid fa-toggle-on"></i></a>
    @else
    <a class="btn btn-dark  btn-sm"  href="{{url('admin/massege/acnotice/'.@$order->id)}}"><i class="fa fa-thin fa-toggle-off"></i></a>
    @endif
    </td> 
...
<td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Massege Update</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
     <form action="{{url('admin/massege/update/')}}" method="post" enctype="multipart/form-data">
@csrf
    ...
    <div class="form-group">
     <input type="submit" name="send" class="btn btn-info" value="Submit" />
        ...
        <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Massege?');" href="{{url('admin/massege/destroy/'.@$order->id)}}"><i class="fa fa-trash"></i></a>
