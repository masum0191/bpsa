...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <!--<ul class="app-menu">-->
      <!--  <li><a class="app-menu__item active" href="/writer/home"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>-->
      
      <!--   <li><a class="app-menu__item" href="{{url('writer/committee')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Committee</span></a></li>-->
      <!--  <li><a class="app-menu__item" href="{{url('writer/slider')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Slider</span></a></li>-->
        
      <!--  <li><a class="app-menu__item" href="{{url('writer/gallery')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Gallery</span></a></li>-->
