...
<div class="row">
    ...
    <a class="btn btn-primary btn-sm" href="{{url('writer/committee/create')}}">  Committee Create</a> 
    </div>
</div>
...
<tr>
    ...
    <td>
       ...
       <form action="{{url('writer/committee/update')}}" method="post" enctype="multipart/form-data">
@csrf
   <div class="form-group">
    ...
    <div class="form-group">
     ...
     <input type="text" name="Association_Year" class="form-control" value="{{$order->Association_Year}}" require />
    </div>
    ...
    <div class="form-group">
     <input type="submit" name="send" class="btn btn-info" value="Submit" />
        ...
        <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this committee?');" href="{{url('writer/committee/destroy/'.@$order->id)}}"><i class="fa fa-trash"></i></a>
