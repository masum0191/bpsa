...
<a class="btn btn-primary btn-sm" href="{{url('writer/gallery/create')}}"> 
     New Gallery</a> 
...
<tr>
    ...
    <a class="btn btn-primary btn-sm" href="{{url('writer/gallery/innotice/'.@$order->id)}}"><i class="fa fa-solid fa-toggle-on"></i></a>
    @else
    <a class="btn btn-dark  btn-sm"  href="{{url('writer/gallery/acnotice/'.@$order->id)}}"><i class="fa fa-thin fa-toggle-off"></i></a>
    @endif
    </td> 
...
<td>
  ...
  <form action="{{url('writer/gallery/update/')}}" method="post" enctype="multipart/form-data">
@csrf
...
<input type="hidden" name="id" class="form-control" value="{{$order->id}}" />
    ...
    <div class="form-group">
     <input type="submit" name="send" class="btn btn-info" value="Submit" />
        ...
        <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this gallery?');" href="{{url('writer/gallery/destroy/'.@$order->id)}}"><i class="fa fa-trash"></i></a>
